...
func main() {
	...
	client, err := gocloudcix.NewClientFromFile("my_settings")
	if err != nil {
	...
	newProject, err := client.Project.New(ctx, gocloudcix.ProjectNewParams{
		Name:     "go-sdk-demo-project-2",
		RegionID: int64(regionID),
		Note:     gocloudcix.String("Demo project created using CloudCIX Go SDK"),
	})
	if err != nil {
