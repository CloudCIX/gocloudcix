...
func TestUserAgentHeader(t *testing.T) {
	...
	_, _ = client.Compute.Backups.List(context.Background(), gocloudcix.ComputeBackupListParams{})
	if userAgent != fmt.Sprintf("Gocloudcix/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Compute.Backups.List(context.Background(), gocloudcix.ComputeBackupListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Compute.Backups.List(cancelCtx, gocloudcix.ComputeBackupListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Compute.Backups.List(deadlineCtx, gocloudcix.ComputeBackupListParams{})
		if err == nil {
